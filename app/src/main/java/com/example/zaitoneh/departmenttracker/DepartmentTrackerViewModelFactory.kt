 ...
 */
class DepartmentTrackerViewModelFactory(
        private val dataSource: DepartmentDatabaseDao,

        private val application: Application) : ViewModelProvider.Factory {
    @Suppress("unchecked_cast")
    override fun <T : ViewModel?> create(modelClass: Class<T>): T {
        if (modelClass.isAssignableFrom(DepartmentTrackerViewModel::class.java)) {
            return DepartmentTrackerViewModel(dataSource, application) as T
        }
