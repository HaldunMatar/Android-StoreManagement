 ...
 */
fun convertDurationToFormatted(startTimeMilli: String, endTimeMilli: String, res: Resources): String {
 ...
 */
fun convertNumericQualityToString(quality: String, resources: Resources): String {
